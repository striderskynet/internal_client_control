        ...
        <table id='main-table' class="table table-striped table-hover align-middle mb-0 bg-white rounded-top">
            ...
            <!-- Data ROW -->
                <tr class='hide' id='data-default' data-user-id="u01">
                    ...
                    <td class="align-middle">{in_date}</td>
                    <td class="align-middle">{out_date}</td>
                    <td class="align-middle">
                        <button id="button_voucher_print" onclick="button_voucher_print(this)" data-user-id="v{voucher_id}" type="button" class="btn btn-primary btn-sm" data-bs-toggle="tooltip" data-mdb-placement="top" title="Imprimir reserva..."><i class="fas fa-print"></i></button>
                        <button id="button_voucher_del" onclick="button_voucher_del(this)" data-user-id="v{voucher_id}" type="button" class="btn btn-danger btn-sm" data-bs-toggle="tooltip" data-mdb-placement="top" title="Borrar reserva..."><i class="fas fa-ban"></i></button>
                    </td>
                </tr>
            </tbody>
        </table>
